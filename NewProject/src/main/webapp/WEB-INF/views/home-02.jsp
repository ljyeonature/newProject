	...
	<header class="header-v2">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="home.html"><img src="resources/main/images/icons/logo-01.png" alt="IMG-LOGO"></a>
			</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs1-slick1">
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url(resources/main/images/slide-04.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30">
	...
	<div class="sec-banner bg0">
		<div class="flex-w flex-c-m">
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="resources/main/images/banner-06.jpg" alt="IMG-BANNER">
			...
			<div class="row">
					...
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.html">
								<img src="resources/main/images/blog-01.jpg" alt="IMG-BLOG">
							</a>
						</div>
				...
				<div class="col-sm-6 col-md-4 p-b-40">
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.html">
								<img src="resources/main/images/blog-02.jpg" alt="IMG-BLOG">
							</a>
						</div>
				...
				<div class="col-sm-6 col-md-4 p-b-40">
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.html">
								<img src="resources/main/images/blog-03.jpg" alt="IMG-BLOG">
							</a>
						</div>
