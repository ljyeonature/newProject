...
<!--===============================================================================================-->	
	<link rel="stylesheet" type="text/css" href="resources/main/vendor/daterangepicker/daterangepicker.css">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="resources/main/vendor/slick/slick.css">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="resources/main/vendor/MagnificPopup/magnific-popup.css">
<!--===============================================================================================-->
...
<body class="animsition">
		...
		<div class="container-menu-desktop trans-03">
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="resources/main/images/icons/logo-02.png" alt="IMG-LOGO">
					</a>
				...
				<div class="sidebar-gallery w-full p-tb-30">
					...
					<div class="flex-w flex-sb p-t-36 gallery-lb">
						...
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="resources/main/images/gallery-01.jpg" data-lightbox="gallery" 
							style="background-image: url('resources/main/images/gallery-01.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="resources/main/images/gallery-02.jpg" data-lightbox="gallery" 
							style="background-image: url('resources/main/images/gallery-02.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="resources/main/images/gallery-03.jpg" data-lightbox="gallery" 
							style="background-image: url('resources/main/images/gallery-03.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="resources/main/images/gallery-04.jpg" data-lightbox="gallery" 
							style="background-image: url('resources/main/images/gallery-04.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="resources/main/images/gallery-05.jpg" data-lightbox="gallery" 
							style="background-image: url('resources/main/images/gallery-05.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="resources/main/images/gallery-06.jpg" data-lightbox="gallery" 
							style="background-image: url('resources/main/images/gallery-06.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="resources/main/images/gallery-07.jpg" data-lightbox="gallery" 
							style="background-image: url('resources/main/images/gallery-07.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="resources/main/images/gallery-08.jpg" data-lightbox="gallery" 
							style="background-image: url('resources/main/images/gallery-08.jpg');"></a>
						</div>

						<!-- item gallery sidebar -->
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="resources/main/images/gallery-09.jpg" data-lightbox="gallery" 
							style="background-image: url('resources/main/images/gallery-09.jpg');"></a>
						</div>
					</div>
				</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs2-slick1">
			<div class="slick1">
				<div class="item-slick1 bg-overlay1" style="background-image: url(resources/main/images/slide-05.jpg);" data-thumb="resources/main/images/thumb-01.jpg" data-caption="Women’s Wear">
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(resources/main/images/slide-06.jpg);" data-thumb="resources/main/images/thumb-02.jpg" data-caption="Men’s Wear">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(resources/main/images/slide-07.jpg);" data-thumb="resources/main/images/thumb-03.jpg" data-caption="Men’s Wear">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
			...
			<div class="row">
				<div class="col-md-6 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="resources/main/images/banner-04.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="resources/main/images/banner-05.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="resources/main/images/banner-07.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="resources/main/images/banner-08.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="resources/main/images/banner-09.jpg" alt="IMG-BANNER">
								...
								<div class="flex-w flex-r-m p-b-10">
									...
									<div class="size-204 respon6-next">
										<div class="rs1-select2 bor8 bg0">
											<select class="resources/main/js-select2" name="time">
...
<!--===============================================================================================-->
	...
	<script src="resources/main/vendor/daterangepicker/daterangepicker.js"></script>
<!--===============================================================================================-->
