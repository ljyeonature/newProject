  ...
  <!--================Login Box Area =================-->
	<section class="login_box_area section-margin">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img index" id="login_box">
						<div class="hover">
							<h4>관리자 메인 페이지</h4>
							<a class="button button-account" href="admin-index">관리자 메인 페이지</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_box_img home" id="login_box">
						<div class="hover">
							<h4>홈페이지</h4>
							<a class="button button-account" href="../member/home">홈페이지</a>
						</div>
					</div>
				</div>
			</div>
